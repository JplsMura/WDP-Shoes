    ...
    <article class="main_product_description">
        <div class="container">
            <header class="main_product_description_header">
                <span class="main_product_description_header_tag">DESCRIÇÂO:</span>
                ...
                <p>
                    ...
                    Ele é confeccionado em tecido elástico, e conta com detalhe em tule na parte da frente,
                    que deixa o visual da peça sensual e muito mais respirável. Não perca tempo e compre já o seu
                    Top Gonew Mármore Detalhe Tule Média Sustentação!
                </p>
